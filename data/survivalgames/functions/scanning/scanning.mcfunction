...
# x
execute if score scanning internal matches 1 as @e[tag=scan,limit=1] unless score x internal <= lastx global if score y internal = lasty global run function survivalgames:scanning/move_x
# z
execute if score scanning internal matches 1 as @e[tag=scan,limit=1] unless score z internal = lastz global if score x internal <= lastx global if score y internal = lasty global run function survivalgames:scanning/move_z
# y
execute if score scanning internal matches 1 as @e[tag=scan,limit=1] unless score y internal >= firsty global run function survivalgames:scanning/move_y
...
execute if score scanning internal matches 1 as @e[tag=scan,limit=1] if score z internal <= lastz global if score x internal <= lastx global run function survivalgames:loot
