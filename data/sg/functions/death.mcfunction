...
# announce
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"☠","color":"red"},{"text":"] ","color":"dark_gray"},{"selector":"@a[scores={death=1..}]","color":"dark_red","bold":true},{"text":" has been eliminated!","color":"red"}]
# sfx
