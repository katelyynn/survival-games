...
tellraw @s ["",{"text":"[","color":"dark_gray"},{"text":"!","color":"green","bold":true},{"text":"] ","color":"dark_gray"},{"text":"Blue","color":"blue"},{"text":" has won with ","color":"yellow"},{"score":{"name":"blue_kills","objective":"internal"},"color":"gold"},{"text":" kills!","color":"yellow"}]
# sfx
